...
import com.example.itaudesafio.data.remote.di.RemoteModule_ProvideHttpClientFactory;
import com.example.itaudesafio.data.repository.WeatherRepositoryImpl;
import com.example.itaudesafio.ui.feature.WeatherViewModel;
import com.example.itaudesafio.ui.feature.WeatherViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerCustomApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends CustomApplication_HiltComponents.ViewModelC {
    ...
    private WeatherRepositoryImpl weatherRepositoryImpl() {
      return new WeatherRepositoryImpl(singletonCImpl.bindRemoteDataSourceProvider.get());
    }
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, Provider<ViewModel>>singletonMap("com.example.itaudesafio.ui.feature.WeatherViewModel", ((Provider) weatherViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.itaudesafio.ui.feature.WeatherViewModel 
          return (T) new WeatherViewModel(viewModelCImpl.weatherRepositoryImpl());
  ...
  private static final class SingletonCImpl extends CustomApplication_HiltComponents.SingletonC {
    private final SingletonCImpl singletonCImpl = this;

    private Provider<HttpClient> provideHttpClientProvider;

    private Provider<KtorRemoteDataSource> ktorRemoteDataSourceProvider;

    private Provider<RemoteDataSource> bindRemoteDataSourceProvider;
    ...
    private void initialize() {
      ...
      this.ktorRemoteDataSourceProvider = new SwitchingProvider<>(singletonCImpl, 0);
      this.bindRemoteDataSourceProvider = DoubleCheck.provider((Provider) ktorRemoteDataSourceProvider);
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.itaudesafio.data.KtorRemoteDataSource 
          return (T) new KtorRemoteDataSource(singletonCImpl.provideHttpClientProvider.get());

          case 1: // io.ktor.client.HttpClient 
          return (T) RemoteModule_ProvideHttpClientFactory.provideHttpClient();
